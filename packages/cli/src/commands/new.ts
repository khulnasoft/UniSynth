...
const command: GluegunCommand = {
  name: 'new',
  alias: 'n',
  description: 'unisynth new [options]',
  async run(toolbox) {
    ...
    await pkg.add(['@khulnasoft.com/unisynth', '@khulnasoft.com/unisynth-cli', 'typescript'], {
      dev: true,
      force: 'npm',
    });
    ...
    toolbox.template.generate({
      template: 'unisynth.config.js.ejs',
      target: 'unisynth.config.js',
    });

    spinner.succeed('Wrote unisynth.config.js ');
