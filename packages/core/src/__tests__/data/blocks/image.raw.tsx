import { onMount, onUnMount, Show, useRef, useState, useStore } from '@khulnasoft.com/unisynth';
...
export interface ImageProps {
  ...
  // TODO: Support generating Khulnasoft.com and or Shopify `srcset`s when needed
  srcset?: string;
      ...
      <picture ref={pictureRef}>
        <Show when={!state.useLazyLoading() || load}>
          <img
            ...
            class={'khulnasoft-image' + (props._class ? ' ' + props._class : '')}
            src={props.image}
