import { For, Show, useContext, useStore } from '@khulnasoft.com/unisynth';
import KhulnasoftContext from '../context/khulnasoft.context.lite';
...
import { KhulnasoftBlock } from '../types/khulnasoft-block';
  ...
  const state = useStore({
    ...
    get useBlock() {
      return getProcessedBlock({
        block: props.block,
        state: khulnasoftContext.state,
        context: khulnasoftContext.context,
      });
    },
    get actions() {
