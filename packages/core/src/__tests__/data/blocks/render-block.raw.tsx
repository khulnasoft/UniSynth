import { For, Show, useStore } from '@khulnasoft.com/unisynth';
import { TARGET } from '../../constants/target.js';
import type { KhulnasoftContextInterface, RegisteredComponent } from '../../context/types.js';
...
export default function RenderBlock(props: RenderBlockProps) {
  const state = useStore({
    ...
    get useChildren() {
      ...
      // This is currently commented out because some Khulnasoft components (e.g. Box) do not have `canHaveChildren: true`,
    ...
    get childrenContext(): KhulnasoftContextInterface {
      return {
