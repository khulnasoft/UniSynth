import { For, onMount, Show, useMetadata, useStore } from '@khulnasoft.com/unisynth';
...
export default function SmileReviews(props: SmileReviewsProps) {
  ...
  onMount(() => {
    fetch(
      `https://stamped.io/api/widget/reviews?storeUrl=khulnasoft-io.myshopify.com&apiKey=${
