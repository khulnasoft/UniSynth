...
import { UnisynthNode, checkIsForNode } from '../../types/unisynth-node';
...
const addUpdateAfterSet = (json: UnisynthComponent, options: InternalToHtmlOptions) => {
...
const getChildComponents = (json: UnisynthComponent, options: InternalToHtmlOptions) => {
...
const getId = (json: UnisynthNode, options: InternalToHtmlOptions) => {
