...
import { StateValue, UnisynthComponent } from '@/types/unisynth-component';
...
export const getUseStateCode = (json: UnisynthComponent, options: ToReactOptions) => {
...
export const updateStateSetters = (json: UnisynthComponent, options: ToReactOptions) => {
  if (options.stateType !== 'useState') {
    return;
  }
