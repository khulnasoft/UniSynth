...
function processDynamicComponents(json: UnisynthComponent, options: ToSolidOptions) {
  let found = false;
...
function getContextString(component: UnisynthComponent, options: ToSolidOptions) {
  let str = '';
...
const getRefsString = (json: UnisynthComponent, options: ToSolidOptions) =>
...
function addProviderComponents(json: UnisynthComponent, options: ToSolidOptions) {
