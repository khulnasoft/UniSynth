...
import { UnisynthState } from '@/types/unisynth-component';
...
export const componentToStencil: TranspilerGenerator<ToStencilOptions> =
  ...
  ({ component }) => {
    ...
    const defaultProps: UnisynthState | undefined = json.defaultProps;
    ...
    if (json.meta.useMetadata?.tagName) {
      // Deprecated option, we shouldn't use this, instead change the name of your Unisynth component
