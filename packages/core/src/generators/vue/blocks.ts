...
import { Binding, ForNode, SpreadType, UnisynthNode } from '@/types/unisynth-node';
...
type BlockRenderer = (json: UnisynthNode, options: ToVueOptions, scope?: Scope) => string;
...
const stringifyBinding =
  (node: UnisynthNode, options: ToVueOptions) =>
...
const stringifySpreads = ({ node, spreadType }: { node: UnisynthNode; spreadType: SpreadType }) => {
...
const getBlockBindings = (node: UnisynthNode, options: ToVueOptions) => {
