...
const getContextProvideString = (json: UnisynthComponent, options: ToVueOptions) => {
  return `{
...
function getContextInjectString(component: UnisynthComponent, options: ToVueOptions) {
  let str = '{';
