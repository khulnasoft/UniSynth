...
/**
 * Parses a JSX element into a UnisynthNode.
 */
export const jsxElementToJson = (
  ...
  // const properties: UnisynthNode['properties'] = {}
    ...
    (memo, item) => {
      if (types.isJSXAttribute(item)) {
        ...
        if (types.isStringLiteral(expression)) {
          ...
          // <Foo myProp={<MoreUnisynthNode><div /></MoreUnisynthNode>} />
