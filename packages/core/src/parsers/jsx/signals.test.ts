...
const code = `
import { Signal, useState, useContext, createContext } from '@khulnasoft.com/unisynth';
...
describe('Signals type parsing', () => {
  /**
   * We can piggyback on the `core` project's TS config, since we are allowed to reference `unisynth`
