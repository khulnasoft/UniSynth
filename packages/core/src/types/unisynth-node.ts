...
export type UnisynthNode = BaseNode | ForNode;

export const checkIsForNode = (node: UnisynthNode): node is ForNode => node.name === 'For';

export const checkIsShowNode = (node: UnisynthNode): node is ShowNode => node.name === 'Show';
