import type { CreateAppResult, IntegrationData } from '../../unisynth/src/cli/types';
import fs from 'node:fs';
import { isAbsolute, join } from 'node:path';
import { cleanPackageJson, writePackageJson } from '../../unisynth/src/cli/utils/utils';
import { updateApp } from '../../unisynth/src/cli/add/update-app';
