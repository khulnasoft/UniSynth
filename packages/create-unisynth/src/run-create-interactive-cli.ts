import { backgroundInstallDeps, installDeps } from '../../unisynth/src/cli/utils/install-deps';
...
import { getPackageManager, note, runCommand, wait } from '../../unisynth/src/cli/utils/utils';
...
export async function runCreateInteractiveCli(): Promise<CreateAppResult> {
  ...
  const defaultProjectName = './unisynth-app';
