    ...
    <footer class="border-t border-primary border-opacity-50 pb-4">
      <div class="container md:my-8 p-8 mx-auto flex gap-4 max-md:flex-col-reverse">
        <div class="block max-md:mt-8">
          <a class="block text-primary-light" href="https://www.khulnasoft.com/" target="_blank">
            Made with ❤️ by
            <img
              ...
              width={200}
              height={90}
              src="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fe2052e9c2ef34dab98709a67fcc4b8c3"
            />
          </a>
          <div class="text-xs mt-4 text-primary-light opacity-90 font-light">
            Copyright © {year} Khulnasoft.com, Inc.
          </div>
        </div>
