...
import { UnisynthLogo } from '~/components/svgs/unisynth-logo';
...
const baseUrl = 'https://unisynth.dev';
const linkColumns = [
  [
    { title: 'Docs', href: `${baseUrl}/docs/` },
    { title: 'Unisynth City', href: `${baseUrl}/docs/unisynthcity/` },
      ...
      <div class="flex justify-center my-12">
        <div class="flex flex-grow justify-center flex-wrap max-w-screen-xl flex-col sm:flex-row gap-y-4">
          <div class="flex-1 sm:flex-[2] flex sm:justify-center sm:block mb-4 sm:mb-0">
            <UnisynthLogo width={170} height={54} />
          </div>
        ...
        <div class="max-w-screen-xl w-full">
          <div class="italic text-xs">
            ...
            <p class="text-xl sm:text-2xl">
              The <strong>Unisynth</strong> Team
            </p>
          </div>
...
export const FooterSocialLinks = component$(() => {
  const socialLinks = [
    { href: 'https://unisynth.dev/chat', title: 'Discord', Logo: DiscordLogo },
    { href: 'https://github.com/khulnasoft/unisynth', title: 'GitHub', Logo: GithubLogo },
    { href: 'https://twitter.com/khulnasoft', title: 'Twitter', Logo: TwitterLogo },
  ];
