...
import { component$, useStyles$, useContext, useVisibleTask$ } from '@khulnasoft.com/unisynth';
...
import { UnisynthLogo } from '../svgs/unisynth-logo';
      ...
      >
        <div class="header-inner">
          <div class="header-logo">
            <a href="/">
              <span class="sr-only">Unisynth Homepage</span>
              <UnisynthLogo width={130} height={44} />
            </a>
          </div>
          <button
            onClick$={() => {
          ...
          <ul class="lg:grow lg:flex lg:justify-end lg:p-4 menu-toolkit">
            ...
            <li>
              <a
                ...
                aria-label="Unisynth playground"
              >
                <span class="unisynthsand" aria-hidden="true">
                  Unisynth Sandbox
                </span>
              </a>
            </li>
            ...
            <li>
              <a href="https://github.com/khulnasoft/unisynth" target="_blank" title="GitHub">
            ...
            <li>
              <a href="https://twitter.com/khulnasoft" target="_blank" title="Twitter">
                <span class="lg:hidden">@khulnasoft</span>
                <span class="hidden lg:block">
            ...
            <li>
              <a href="https://unisynth.dev/chat" target="_blank" title="Discord">
