import { Slot, component$, useContext, useSignal, $, type PropsOf } from '@khulnasoft.com/unisynth';
...
// TODO: refactor unisynth ui tabs to pass in refs and allow content inside of the tabs root (for example, absolute positioning)
