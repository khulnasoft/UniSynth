...
export const RouterHead = component$(() => {
  ...
  const title = head.title
    ? `${head.title} 📚 Unisynth Documentation`
    : `Unisynth - Framework reimagined for the edge`;
  const description =
  ...
  const OGImage = {
    ...
    get URL() {
      ...
      const ogImageUrl = new URL('https://opengraphunisynth.vercel.app/api/og?level=1');

      // biggerTitle
      this.ogImgTitle = arrayedTitle[0];
      //smallerTitle
      this.ogImgSubTitle = arrayedTitle[1]
        ? arrayedTitle[1].replace(' 📚 Unisynth Documentation', '')
        : undefined;
  ...
  return (
    <>
      ...
      <meta name="apple-mobile-web-app-title" content="Unisynth" />
      <meta name="application-name" content="Unisynth" />
      <meta name="apple-mobile-web-app-title" content="Unisynth" />
