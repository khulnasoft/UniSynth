...
export const MEDIA = mediaObj({
  ...
  courses: [
    ...
    youtube('Unisynth en 2 horas', 'FF3D4tppyag', {
      language: 'es',
      promoted: true,
      author: 'Leifer Mendez',
    }),
    {
      href: 'https://cursos.devtalles.com/courses/unisynth-introduccion',
      imgSrc:
        'https://import.cdn.thinkific.com/643563/courses/2285840/hD0Nof2mTK2cVOWvRJg2_UNISYNTH-COVER-CURSO.jpg',
      title: 'Fernando Herrera + DevTalles',
      language: 'es',
      author: 'Dev Talles',
      promoted: true,
    },
    youtube('⭐️ Domina UNISYNTH, el revolucionario framework de JS', 'X4puVLRTr4k', {
      language: 'es',
      author: 'Manuel Sánchez WEB',
    }),
    {
      href: 'https://www.udemy.com/course/curso-intermedio-unisynth-espanol/?referralCode=3D453D600C0CB529D84B',
      imgSrc: 'https://www.manuelsanchezweb.com/img/unisynth-intermedio.png',
      title: 'Unisynth intermedio-avanzado con proyectos',
      language: 'es',
      author: 'Manuel Sánchez',
    },
    youtube('Unisynth 1.0 - новый подход frontend разработки?', 'ajTNL88BN5E', {
      language: 'ru',
      promoted: true,
      author: 'PurpleSchool | Anton Larichev',
    }),
    youtube('UnisynthJS course in Arabic', 'irQDABJZw5c', {
  ...
  /*****************************************/
  videos: [
    youtube("Unisynth… the world's first O(1) JavaScript framework?", 'x2eF3YLiNhY', {
      promoted: true,
      author: 'Fireship',
    }),
    youtube('Unisynth: Performance is a Human Design Issue | ViteConf 2023', 'bvSlEweRyjE', {
      promoted: true,
    }),
    youtube(
      'Miško Hevery: Creator of AngularJS & now Unisynth | The Frontend Masters Podcast Ep.4',
      'CcLgQaJIyn0',
      {
        promoted: true,
      }
    ...
    youtube(
      'Using Unisynth To Turn React Application Into Lazy Hydration Islands - Misko Hevery',
      'XvpwF_xTZcU',
      {
        promoted: true,
      }
    ...
    youtube(
      'Effortless Server Communication & Multithreading in Unisynth - Yoav Ganbar',
      'lEc2BM5HmJ8',
      {
        promoted: true,
      }
  ...
  /*****************************************/
  podcasts: [
    youtube('Unisynth City for Resumable, Dynamic Apps', 'cJJdrYnsl6U', {
      promoted: true,
      author: 'Learn with Jason',
    }),
    youtube('Unisynth + React State (and a new mic!)', 'fa6-Mn0Eybg', {
      promoted: true,
      author: 'Theo - t3.gg',
    }),
    youtube(
      'Miško Hevery: Unisynth, PartyTown, and Lessons from Angular [Swyx Mixtape]',
      'T3K_DrgLPXM',
      { promoted: true, author: 'swyx' }
    ),
    youtube('Introducing Unisynth w/ Misko Hevery & Shai Reznik', 'iJZaT-AvJ-o', {
      promoted: true,
      author: 'Angular Nation',
    }),
    youtube('Resumable Apps in Unisynth', 'LbMRs7l4czI', { promoted: true, author: 'Tony Alicea' }),
    youtube('Unisynth: A no-hydration instant-on personalized web applications', '0tCuUQe_ZA0', {
      promoted: true,
      author: 'This Dot Media',
    }),
    youtube('UNISYNTH - Set of great demos by Misko Hevery', '7MgNMIPISY4', {
    ...
    youtube('Unisynth with Miško Hevery (JS Party Live!)', 'rS8hXFHWKJQ', { author: 'Changelog' }),
    youtube(
      'JSMP 4: Misko Hevery on Unisynth - No hydration, auto lazy-loading, edge cacheable, and fun',
      'wMnqgjHkLiY',
      { author: 'JS Poland Conf' }
    ),
    {
      href: 'https://podrocket.logrocket.com/unisynth',
      imgSrc:
      ...
      title: 'Unisynth with Yoav Ganbar',
    ...
    },
    {
      ...
      title: 'FedBites: Unisynth Special with Miško Hevery & Adam Bradley',
      author: 'FedBites',
    },
    {
      href: 'https://open.spotify.com/episode/2dl2QegrUBnepz0RHZ17rG?si=EfvbNWURT1-9u1Z34BVd1g',
      imgSrc: 'https://devtalles.com/files/unisynth/podcast-banner.jpg',
      title: 'DevTalles 113: unisynth v1.0',
      author: 'DevTalles',
    },
  ],
  ...
  /*****************************************/
  presentations: [
    youtube('Unisynth framework overview', 'Jf_E1_19aB4', {
      startTime: 629,
      promoted: true,
      author: 'Misko Hevery',
    }),
    youtube(
      'Mindblowing Google PageSpeed Scores with Unisynth | Misko Hevery | Reliable Web Summit 2021',
      'sCPLWf2cEY0',
      { promoted: true, author: 'ng-conf' }
    ),
    youtube(
      'WWC22 - Unisynth + Partytown: How to remove 99% of JavaScript from main thread',
      '0dC11DMR3fU',
      { startTime: 154, promoted: true, author: 'WeAreDevelopers' }
    ),
    youtube(
      'Unisynth: A holly grail of progressive hydration for ultimate speed by Miško Hevery',
      'JxYbg7eZNLY',
    ...
    youtube('Unisynth Workshop Part 1 - Live Coding', 'GHbNaDSWUX8', { author: 'Pull Request' }),
    youtube('Unisynth: Beta and Beyond', 'Tfd62DiRTKc', { author: 'Builder' }),
    youtube('Unisynth Core Developers Training', 'Mi7udzhcCDQ', { author: 'Misko Hevery' }),
  ],
  ...
  blogs: [
    ...
    {
      href: 'https://www.builder.io/blog/unisynth-city-server-functions',
      imgSrc:
      ...
      title: 'Introducing Unisynth City Server Functions',
      author: 'Manu Mtz.-Almeida',
    },
    {
      href: 'https://www.builder.io/blog/resumable-react-how-to-use-react-inside-unisynth',
      imgSrc:
      ...
      title: 'Resumable React: How to Use React Inside Unisynth',
      author: 'Yoav Ganbar',
    },
    {
    ...
    {
      href: 'https://www.builder.io/blog/the-qase-for-unisynth-love-at-first-tti',
      imgSrc:
      ...
      title: 'The Qase for Unisynth: Love At First TTI',
      author: 'Yoav Ganbar',
    },
    {
    ...
    {
      href: 'https://www.builder.io/blog/why-is-builderio-creating-unisynth-and-partytown',
      imgSrc:
      ...
      title: 'Why is Builder.io creating Unisynth and Partytown?',
      author: 'Miško Hevery',
    },
    {
    ...
    {
      href: 'https://dev.to/builderio/a-first-look-at-unisynth-the-html-first-framework-af',
      imgSrc:
      ...
      title: 'A first look at Unisynth - the HTML first framework',
      author: 'Builder.io',
    },
    {
      href: 'https://dev.to/mhevery/death-by-closure-and-how-unisynth-solves-it-44jj',
      imgSrc:
      ...
      title: 'Death by Closure (and how Unisynth solves it)',
      author: 'Builder.io',
    },
    {
    ...
    {
      href: 'https://dev.to/mhevery/unisynth-the-answer-to-optimal-fine-grained-lazy-loading-2hdp',
      imgSrc:
      ...
      title: 'Unisynth: the answer to optimal fine-grained lazy loading',
      author: 'Builder.io',
    },
    {
    ...
    {
      href: 'https://dev.to/builderio/how-we-cut-99-of-our-javascript-with-unisynth-partytown-3i3k',
      imgSrc:
      ...
      title: 'How we cut 99% of our JavaScript with Unisynth + Partytown',
      author: 'Builder.io',
    },
    {
      href: 'https://dev.to/builderio/introducing-unisynth-starters-get-up-and-running-with-unisynth-now-3ap2',
      imgSrc: '',
      title: 'Introducing Unisynth starters - get up and running with Unisynth now',
      author: 'Builder.io',
    },
  ],
  ...
  ['case studies']: [
    {
      href: 'https://tzdesign.de/en/blog/how-10-engineers-deliver-exactly-what-the-browser-wants-with-unisynth',
      imgSrc: '',
      title:
        'How 10 Engineers Deliver Exactly What the Browser Wants with Unisynth - by Tobias Zimmermann',
    },
    {
      href: 'https://www.theseus.fi/bitstream/handle/10024/795367/Cao_Xuan-An.pdf',
      imgSrc: '',
      title:
        'HEADLESS CMS AND UNISYNTH FRAMEWORK; their practicalities in the future of application development - by Xuan-An Cao',
    },
    {
  ...
  resources: [
    {
      ...
      title: 'Unisynth City - Google Presentation Template',
      author: '',
    },
    {
      href: 'https://docs.google.com/presentation/d/1Jj1iw0lmaecxtUpqyNdF1aBzbCVnSlbPGLbOpN2xydc/edit#slide=id.g13225ffe116_6_234',
      title: 'Unisynth - Google Presentation Template',
    },
    {
      href: 'https://docs.google.com/presentation/d/1cGbC-FFMrLCQ62YDGG17jf3Eh0hqwMBlyDQZGeoFNyw/edit#slide=id.g1620a79b097_0_300',
      title: 'Unisynth the O(1) framework',
    },
    { href: '/logos/unisynth-logo.svg', title: 'Unisynth Logo [svg]' },
    { href: '/logos/unisynth.svg', title: 'Unisynth Logo and Text [svg]' },
    { href: '/logos/unisynth.png', title: 'Unisynth Logo and Text [png]' },
  ],
});
  ...
  return (
    <li>
      <a href={props.entry.href} target="_blank" rel="noreferrer">
        <div class="relative">
          <img
            src={props.entry.imgSrc ? props.entry.imgSrc : '/ecosystem/unisynth-blog-fallback.png'}
...
export default component$(() => {
  ...
  return (
    <article class="media">
      <h1>Unisynth Courses, Presentations, Talks, Videos and Podcasts</h1>
      ...
      <section>
        ...
        <p>
          <a
            href="https://github.com/khulnasoft/unisynth/edit/main/packages/docs/src/routes/(ecosystem)/media/index.tsx"
            target="_blank"
            class="edit-page"
          >
            Edit this page!
...
export const head: DocumentHead = {
  title: 'Unisynth Presentations, Talks, Videos and Podcasts',
};
