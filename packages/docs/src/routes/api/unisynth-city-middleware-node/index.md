---
title: \@khulnasoft.com/unisynth-city/middleware/node API Reference
---

# [API](/api) &rsaquo; @khulnasoft.com/unisynth-city/middleware/node

## createUnisynthCity

```typescript
export declare function createUnisynthCity(opts: UnisynthCityNodeRequestOptions): {
  router: (
...
[UnisynthCityNodeRequestOptions](#unisynthcitynoderequestoptions)
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/middleware/node/index.ts)
...
## UnisynthCityNodeRequestOptions

```typescript
export interface UnisynthCityNodeRequestOptions extends ServerRenderOptions
```
