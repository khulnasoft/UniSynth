---
title: \@khulnasoft.com/unisynth-city API Reference
---

# [API](/api) &rsaquo; @khulnasoft.com/unisynth-city
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/runtime/src/types.ts)
...
Readonly&lt;UnisynthIntrinsicElements['script']&gt;
...
Readonly&lt;UnisynthIntrinsicElements['style']&gt;
...
Form: <O, I>(
  ...
  key: string | null,
) => import("@khulnasoft.com/unisynth").JSXOutput;
```
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/runtime/src/form-component.tsx)

## FormProps

```typescript
export interface FormProps<O, I> extends Omit<UnisynthJSX.IntrinsicElements['form'], 'action' | 'method'>
```

**Extends:** Omit&lt;UnisynthJSX.IntrinsicElements['form'], 'action' \| 'method'&gt;
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/runtime/src/server-functions.ts)
...
```typescript
Link: import("@khulnasoft.com/unisynth").Component<LinkProps>;
```

[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/runtime/src/link-component.tsx)
...
## UNISYNTH_CITY_SCROLLER

```typescript
UNISYNTH_CITY_SCROLLER = "_qCityScroller";
```

[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/runtime/src/unisynth-city-component.tsx)

## UnisynthCityMockProps

```typescript
export interface UnisynthCityMockProps
```
...
```typescript
UnisynthCityMockProvider: import("@khulnasoft.com/unisynth").Component<UnisynthCityMockProps>;
```
...
```typescript
export interface UnisynthCityPlan
```
...
```typescript
export interface UnisynthCityProps
```
...
```typescript
UnisynthCityProvider: import("@khulnasoft.com/unisynth").Component<UnisynthCityProps>;
```
...
```typescript
RouterOutlet: import("@khulnasoft.com/unisynth").Component<unknown>;
```

[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/runtime/src/router-outlet-component.tsx)
...
ServiceWorkerRegister: (props: { nonce?: string }) =>
  import("@khulnasoft.com/unisynth").JSXNode<"script">;
```
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/runtime/src/sw-component.tsx)
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/runtime/src/use-functions.ts)
