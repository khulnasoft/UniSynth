---
title: \@khulnasoft.com/unisynth/server API Reference
---

# [API](/api) &rsaquo; @khulnasoft.com/unisynth/server

## getUnisynthLoaderScript

Provides the `unisynthloader.js` file as a string. Useful for tooling to inline the unisynthloader script into HTML.

```typescript
export declare function getUnisynthLoaderScript(opts?: { debug?: boolean }): string;
```
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth/src/server/scripts.ts)

## getUnisynthPrefetchWorkerScript

Provides the `unisynth-prefetch-service-worker.js` file as a string. Useful for tooling to inline the unisynth-prefetch-service-worker script into HTML.

```typescript
export declare function getUnisynthPrefetchWorkerScript(opts?: {
  debug?: boolean;
}): string;
```
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth/src/server/types.ts)
...
```typescript
export interface UnisynthLoaderOptions
```
...
[UnisynthLoaderOptions](#unisynthloaderoptions)

</td><td>

_(Optional)_ Specifies if the Unisynth Loader script is added to the document or not.
...
UnisynthPrefetchServiceWorkerOptions

</td><td>

_(Optional)_ Specifies if the Unisynth Prefetch Service Worker script is added to the document or not.
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth/src/server/render.ts)
...
UnisynthManifest \| ResolvedManifest \| undefined
...
UnisynthManifest \| ResolvedManifest
...
[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth/src/server/index.ts)
...
```typescript
versions: {
    readonly unisynth: string;
    readonly unisynthDom: string;
}
```

[Edit this section](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth/src/server/utils.ts)
