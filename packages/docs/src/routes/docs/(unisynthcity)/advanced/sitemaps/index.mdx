...
description: Learn how to generate a sitemap for your site in Unisynth City.
contributors:
  - adamdbradley
  - hbendev
  - mrhoodz
...
import { routes } from "@unisynth-city-plan";
...
This route dynamically creates the sitemap XML based on the routes in your Unisynth City application.
