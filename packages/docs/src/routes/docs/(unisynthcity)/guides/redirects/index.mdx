...
description: Learn how to use redirects in Unisynth City.
contributors:
  - adamdbradley
  - manucorporat
  - mhevery
...
If you do not provide a status code, Unisynth City will default to a `302` Found status.
...
- Layouts: Grabbing data inside a [root layout's onGet handler](https://unisynth.dev/docs/routing/#middleware-layouts).
