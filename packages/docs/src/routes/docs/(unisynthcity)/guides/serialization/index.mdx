...
description: Learn about serialization and serialization boundaries in Unisynth, the process of converting data into a format that can be stored or transmitted.
contributors:
  - fabien0102
  - wuweiweiwu
  - manucorporat
...
export const Greeter = component$(() => {
  ...
  const capturePromise = Promise.resolve('Unisynth serializes promises');
  ...
  return (
    <button
      onClick$={() => {
        ...
        // will fail at runtime because Unisynth does not know how to serialize it.
