...
Pages are created by adding a new `index.tsx` file in the `src/routes` directory. Pages export a `default` Unisynth component, which will be rendered as the content of the page.
