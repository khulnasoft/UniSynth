...
Thanks to the [Algolia](https://www.algolia.com/) APIs it is very simple to integrate it into your Unisynth application.
...
Many times it makes sense to have a modal where you show the search and the results, such as the search you find in this Unisynth documentation.
