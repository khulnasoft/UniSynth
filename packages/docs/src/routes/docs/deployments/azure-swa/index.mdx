...
Unisynth City Azure Static Web Apps middleware allows you to connect Unisynth City to [Azure Static Web Apps](https://learn.microsoft.com/azure/static-web-apps/).
...
<span q:slot="pnpm">
```shell
pnpm run unisynth add azure-swa
```
</span>
<span q:slot="npm">
```shell
npm run unisynth add azure-swa
```
</span>
<span q:slot="yarn">
```shell
yarn run unisynth add azure-swa
```
</span>
<span q:slot="bun">
```shell
bun run unisynth add azure-swa
```
</span>
</PackageManagerTabs>
