...
Unisynth City Cloudflare Pages adapter allows you to connect Unisynth City to [Cloudflare Pages](https://pages.cloudflare.com/).
...
<span q:slot="pnpm">
```shell
pnpm run unisynth add cloudflare-pages
```
</span>
<span q:slot="npm">
```shell
npm run unisynth add cloudflare-pages
```
</span>
<span q:slot="yarn">
```shell
yarn run unisynth add cloudflare-pages
```
</span>
<span q:slot="bun">
```shell
bun run unisynth add cloudflare-pages
```
</span>
</PackageManagerTabs>
...
to setup your Unisynth app it will likely use a different nodejs version than what Cloudflare Pages uses by default (v16.20.2).
...
[Read the full guide here](https://github.com/khulnasoft/unisynth/tree/main/starters/adapters/cloudflare-pages/README.md)
...
Please refer to the [Cloudflare Pages docs](https://developers.cloudflare.com/pages/framework-guides/deploy-a-unisynth-site/) for more information on how to deploy your site.
...
- [Cloudflare Pages Middleware Source](https://github.com/khulnasoft/unisynth/tree/main/packages/unisynth-city/src/middleware/cloudflare-pages/index.ts)
...
import { type PlatformCloudflarePages } from '@khulnasoft.com/unisynth-city/middleware/cloudflare-pages';
