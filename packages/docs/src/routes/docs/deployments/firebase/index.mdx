...
Unisynth City Firebase Adapter allows you to connect Unisynth City to [Firebase](https://firebase.google.com/docs/hosting).
...
<span q:slot="pnpm">
```shell
pnpm run unisynth add firebase
```
</span>
<span q:slot="npm">
```shell
npm run unisynth add firebase
```
</span>
<span q:slot="yarn">
```shell
yarn run unisynth add firebase
```
</span>
<span q:slot="bun">
```shell
bun run unisynth add firebase
```
</span>
</PackageManagerTabs>
