...
Unisynth City Cloud Run middleware allows you to run a Unisynth City app on [Google Cloud Run](https://cloud.google.com/run)
...
<span q:slot="pnpm">
```shell
pnpm run unisynth add cloud-run
```
</span>
<span q:slot="npm">
```shell
npm run unisynth add cloud-run
```
</span>
<span q:slot="yarn">
```shell
yarn run unisynth add cloud-run
```
</span>
<span q:slot="bun">
```shell
bun run unisynth add cloud-run
```
</span>
</PackageManagerTabs>
