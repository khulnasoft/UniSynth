...
Unisynth City Netlify Edge adapter allows you to connect Unisynth City to [Netlify Edge Functions](https://docs.netlify.com/edge-functions/overview/).
...
<span q:slot="pnpm">
```shell
pnpm run unisynth add netlify-edge
```
</span>
<span q:slot="npm">
```shell
npm run unisynth add netlify-edge
```
</span>
<span q:slot="yarn">
```shell
yarn run unisynth add netlify-edge
```
</span>
<span q:slot="bun">
```shell
bun run unisynth add netlify-edge
```
</span>
</PackageManagerTabs>
...
[Read the full guide here](https://github.com/khulnasoft/unisynth/blob/main/starters/adapters/netlify-edge/README.md)
...
import { createUnisynthCity } from '@khulnasoft.com/unisynth-city/middleware/netlify-edge';
...
- [Netlify Edge Middleware Source](https://github.com/khulnasoft/unisynth/blob/main/packages/unisynth-city/src/middleware/netlify-edge/index.ts)
