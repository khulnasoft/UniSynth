...
[Builder.io](https://builder.io/) is a Visual Headless CMS. Think about it as a drag-and-drop CMS that integrates into your existing Unisynth codebase, allowing you and your team to edit content without having to write code.
...
<span q:slot="pnpm">
```shell
pnpm run unisynth add builder.io
```
</span>
<span q:slot="npm">
```shell
npm run unisynth add builder.io
```
</span>
<span q:slot="yarn">
```shell
yarn run unisynth add builder.io
```
</span>
<span q:slot="bun">
```shell
bun run unisynth add builder.io
```
</span>
</PackageManagerTabs>
...
Now, let's create a page in Builder.io and see it live in Unisynth!

1. Go to [https://builder.io/content](https://builder.io/content)
2. Click `+ New` and choose `Page`
3. Give it a name and click `Create`

Now, try out the visual editor! You can find a custom Unisynth components
...
One of the killer features of a Visual Headless CMS, is that you can [expose your components](https://www.builder.io/c/docs/custom-components-setup) to the CMS, ie, your Unisynth components can be used as blocks in Builder.io.
...
Also, when you push your integration to production, go back and update your preview URL to your production URL so now anyone on your team can visually create content in your Unisynth app!
