...
Unisynth supports responsive images.
...
#### Key Points
The community and the Unisynth team love this API for a number of reasons:
...
- Site with detailed instructions on usage: [@unpic/qwik](https://unpic.pics/img/unisynth/)
...
> **Note:** unisynth-image and unpic are not a CDN and does not host your images. They work with existing image optimization CDNs. We suggest using some of the popular CDNs:
> - Cloudinary
> - Cloudflare
> - Bunny.net
> - Vercel / Next.js
...
<span q:slot="pnpm">
```shell
pnpm install unisynth-image
```
</span>
<span q:slot="npm">
```shell
npm install unisynth-image
```
</span>
<span q:slot="yarn">
```shell
yarn add unisynth-image
```
</span>
<span q:slot="bun">
```shell
bun install unisynth-image
```
</span>
</PackageManagerTabs>
...
<CodeSandbox src="/src/routes/demo/integration/img/unisynth-image/index.tsx" style={{ height: '40em' }}>
```tsx
import { $, component$ } from '@khulnasoft.com/unisynth';
import {
  Image,
...
Here is the Github repository with detailed instructions on usage and customizations: [unisynthifiers/unisynth-image](https://github.com/unisynthifiers/unisynth-image)
