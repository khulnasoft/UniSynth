...
You can add Playwright easily by using the following Unisynth starter script:


<PackageManagerTabs>
<span q:slot="pnpm">
```shell
pnpm run unisynth add playwright
```
</span>
<span q:slot="npm">
```shell
npm run unisynth add playwright
```
</span>
<span q:slot="yarn">
```shell
yarn run unisynth add playwright
```
</span>
<span q:slot="bun">
```shell
bun run unisynth add playwright
```
</span>
</PackageManagerTabs>
