...
Learn more on the [Tauri website](https://tauri.app/v1/guides/getting-started/setup/unisynth/).

## Adapter
Make sure you use the [Static Adapter](https://unisynth.dev/docs/deployments/static/).
