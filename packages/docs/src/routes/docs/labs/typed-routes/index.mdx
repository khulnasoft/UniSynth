...
2. update `vite.config.ts`
   ```typescript
   // ...
   import { unisynthTypes } from '@khulnasoft.com/unisynth-labs/vite';

   export default defineConfig(() => {
     return {
       plugins: [
        // ...
        unisynthTypes() // <== Add `unisynthTypes()` to the list of plugins
       ],
       // ...
     };
   });
...
# Declarative Routing
This is a package originally created by Jack Herrington aka *"The Blue Collar Coder"* for type safe routing inside NextJS applications and has been adapted for use inside UnisynthCity
...
- [UnisynthCity Setup Instructions](https://github.com/ProNextJS/declarative-routing/blob/main/docs/unisynthcity.md)
- [Example Repos](https://github.com/ProNextJS/declarative-routing/tree/main/examples/unisynthcity)
