---
title: Using Libraries - Unisynth
---
...
You can use any JavaScript library in your Unisynth components just like you would in any
other framework. Here's an example of using `lodash` in a Unisynth component:
...
Because of the cross-framework nature of Unisynth, you cannot use framework-specific libraries
directly in Unisynth code.

For instance a React form library wouldn't make sense in the context of Unisynth, because
Unisynth components are framework-agnostic, so how would it work with Vue or Svelte?
...
In the `overrides/` directory of a [Unisynth project](/docs/project-structure/), you can create a file for each
...
See examples in the [overrides directory](https://github.com/khulnasoft/khulnasoft/tree/main/packages/sdks/overrides)
of the khulnasoft.com SDK.
