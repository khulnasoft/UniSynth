...
import { type DocumentHead, useLocation } from '@khulnasoft.com/unisynth-city';
  ...
  useTask$(({ track }) => {
    ...
    if (isBrowser) {
      ...
      if (shareData) {
        ...
        document.title = `REPL Playground - Unisynth`;
        return;
      }
    }
    store.files = app?.inputs || [];
    if (typeof document !== 'undefined') {
      document.title = `${app?.title} - Unisynth`;
    }
  });
    ...
    <div class="examples full-width fixed-header">
      ...
      >
        <div class="examples-menu">
          ...
          <a
            href="https://github.com/khulnasoft/unisynth/tree/main/packages/docs/src/routes/examples/apps/"
