...
export default component$(() => {
  useStylesScoped$(`
    .wrapper {
      background-image: url('https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Ff234065eeddc488f8189c4fab8e03bde');
    ...
    <div class="wrapper">
      <div class="pt-8 flex flex-col px-4 min-h-[90vh] container mx-auto">
        <img
          ...
          src="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F0fdb9aabd10f4205b3b3b56d7b950239"
        />
...
export const head: DocumentHead = {
  title: 'Unisynth - Write components once, run everywhere.',
  meta: [
    {
      name: 'description',
      content:
