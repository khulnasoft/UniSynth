...
Styling is an important part of the design of a web application. Unisynth is responsible for loading the style information when a component is mounted. Use [`useStyles$()`](/docs/(unisynth)/components/styles/index.mdx#usestyles) to tell Unisynth which style should be loaded.
