...
export const loaderLocation: Rule.RuleModule = {
  meta: {
    ...
    docs: {
      ...
      recommended: true,
      url: 'https://unisynth.dev/docs/advanced/eslint/#loader-location',
    },
    schema: [
      {
        type: 'object',
...
(docs: https://unisynth.dev/docs/route-loader/).
...
(docs: https://unisynth.dev/docs/cookbook/re-exporting-loaders/).

If you understand this, you can disable this warning with:
// eslint-disable-next-line unisynth/loader-location
`,
      missingExport:
...
export const loaderLocationExamples: UnisynthEslintExamples = {
