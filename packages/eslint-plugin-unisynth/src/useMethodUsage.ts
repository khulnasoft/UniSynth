...
import type { UnisynthEslintExamples } from '../examples';
...
export const useMethodUsage: Rule.RuleModule = {
  meta: {
    ...
    docs: {
      ...
      category: 'Variables',
      recommended: true,
      url: 'https://unisynth.dev/docs/advanced/eslint/#use-method-usage',
    },
    messages: {
...
export const useMethodUsageExamples: UnisynthEslintExamples = {
  useWrongFunction: {
    good: [
      {
