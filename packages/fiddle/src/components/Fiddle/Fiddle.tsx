import type { ToReactOptions, UnisynthComponent } from '@khulnasoft.com/unisynth';
import {
    Button,
    Divider,
    FormControlLabel,
...
const unisynthCore = () => {
  console.log('importing unisynth...');
  return import('@khulnasoft.com/unisynth');
};
...
const AlphaPreviewMessage = () => (
  ...
  >
    ...
    >
      Unisynth is in beta, please{' '}
      <TextLink
        css={{ color: 'inherit', textDecoration: 'underline' }}
        href="https://github.com/khulnasoft/unisynth/issues"
        target="_blank"
      >
  ...
  const state = useLocalObservable(() => ({
    ...
    async updateOutput() {
      try {
        ...
        const { parseSvelte, parseJsx } = await unisynthCore();
        ...
        >
          ...
          >
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/khulnasoftio/unisynth"
              css={{
                marginRight: 'auto',
                paddingLeft: 20,
              }}
            >
              <Image alt="Unisynth Logo" src={'/unisynth-logo-white.png'} width={130} height={40} />
            </a>
            <div
              css={{
                marginLeft: 'auto',
              ...
              >
                <Tab
                  label={
                    <TabLabelWithIcon
                      label="Unisynth JSX"
                      icon="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F98d1ee2d3215406c9a6a83efc3f59494"
                    />
                  }
                  value="jsx"
                />
              ...
              >
                <Tab
                  label={
                    <TabLabelWithIcon
                      label="Vue"
                      icon="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fb7d34a76a77b40e2a981ef420d12d1c8"
                    />
                  }
                  value="vue"
                />
                <Tab
                  label={
                    <TabLabelWithIcon
                      label="React"
                      icon="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F1c7afa570a734d9f98e8ad45df0755e2"
                    />
                  }
                  value="react"
                />
                ...
                <Tab
                  label={
                    <TabLabelWithIcon
                      label="Solid"
                      icon="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F3835d178881b44db8fc51d3569ae97c6"
                    />
                  }
                  value="solid"
                />
                ...
                <Tab
                  label={
                    <TabLabelWithIcon
                      label="Liquid"
                      icon="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Ff98433f5a2b747f094bf01e2e88bde08"
                    />
                  }
                  value="liquid"
                />
                <Tab label={<TabLabelWithIcon label="Template" />} value="template" />
                <Tab label={<TabLabelWithIcon label="Unisynth" />} value="unisynth" />
                <Tab
                  label={
                    <TabLabelWithIcon
                      label="JSON"
                      icon="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fa64744451c9546a085a3ca662f7d5572"
                    />
                  }
                  value="json"
                />
                ...
                <MonacoEditor
                  ...
                  language={
                    state.outputTab === 'swift'
                      ? 'swift'
                      : state.outputTab === 'json' || state.outputTab === 'khulnasoft'
                      ? 'json'
