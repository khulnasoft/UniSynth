...
const JsxRuntimeTypes = require('!!raw-loader!@khulnasoft.com/unisynth/jsx-runtime').default;
const UnisynthTypes = require('!!raw-loader!@khulnasoft.com/unisynth/types').default;
...
export function JsxCodeEditor(props: Props) {
  ...
  useEffect(() => {
    ...
    monaco.languages.typescript.typescriptDefaults.addExtraLib(
      UnisynthTypes,
      'file:///node_modules/@khulnasoft.com/unisynth/index.d.ts',
    );
    monaco.languages.typescript.typescriptDefaults.addExtraLib(
      JsxRuntimeTypes,
