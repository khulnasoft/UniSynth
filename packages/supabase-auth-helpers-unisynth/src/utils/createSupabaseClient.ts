import type { RequestEventBase } from '@khulnasoft.com/unisynth-city';
import type {
...
import { UnisynthServerAuthStorageAdapter } from './storageAdapter';
  ...
  return createSupabaseClient<Database, SchemaName, Schema>(supabaseUrl, supabaseKey, {
    ...
    global: {
      ...
      headers: {
        ...
        'X-Client-Info': 'supabase-auth-helpers-unisynth@0.0.3',
      },
    },
    auth: {
 ...
 *
 * ```ts
 * import { createServerClient } from '@supabase/auth-helpers-unisynth';
 ...
 * import { routeAction$ } from '@khulnasoft.com/unisynth-city';
 *
 ...
 * import { useVisibleTask$ } from '@khulnasoft.com/unisynth';
 *
 * useVisibleTask$(() => {
...
>(
  ...
  return createSupabaseClient<Database, SchemaName, Schema>(supabaseUrl, supabaseKey, {
    ...
    auth: {
      storageKey: cookieOptions?.name,
      storage: new UnisynthServerAuthStorageAdapter(requestEv, cookieOptions),
    },
  });
}
