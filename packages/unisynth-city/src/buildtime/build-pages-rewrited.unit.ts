...
test('translated pathname / with prefix', ({ assertRoute }) => {
  ...
  assert.ok(r.filePath.endsWith('starters/apps/unisynthcity-test/src/routes/(common)/index.tsx'));
});
...
test('translated pathname /docs/getting-started with prefix', ({ assertRoute }) => {
  ...
  assert.ok(
    r.filePath.endsWith('starters/apps/unisynthcity-test/src/routes/docs/getting-started/index.md')
  );
});
...
test('translated pathname /docs/[category]/[id] with prefix', ({ assertRoute }) => {
  ...
  assert.ok(
    r.filePath.endsWith('starters/apps/unisynthcity-test/src/routes/docs/[category]/[id]/index.tsx')
  );
});
...
test('translated pathname /about-us with prefix', ({ assertRoute }) => {
  ...
  assert.ok(
    r.filePath.endsWith('starters/apps/unisynthcity-test/src/routes/(common)/about-us/index.tsx')
  );
});
