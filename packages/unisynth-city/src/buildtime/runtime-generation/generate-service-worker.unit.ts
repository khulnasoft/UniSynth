...
test('incorporate unisynth-insights', () => {
  ...
  const manifest: UnisynthManifest = {
    bundles: {
      ...
      } /* satisfies Partial<UnisynthManifest['bundles'][0]> */ as any,
      'q-bundle-b.js': {
  ...
  } /* satisfies Partial<UnisynthManifest> */ as any;
...
test('generateAppBundles', () => {
  const fakeManifest = {
    symbols: {
      s_aaa123: { hash: 'aaa123' } as UnisynthSymbol,
      s_bbb123: { hash: 'bbb123' } as UnisynthSymbol,
      s_ccc123: { hash: 'ccc123' } as UnisynthSymbol,
      s_ddd123: { hash: 'ddd123' } as UnisynthSymbol,
      s_eee123: { hash: 'eee123' } as UnisynthSymbol,
    } as Record<string, UnisynthSymbol>,
    bundles: {
      'a.js': {
        size: 0,
        imports: ['b.js', 'c.js'],
    ...
    } as Record<string, UnisynthBundle>,
  } as UnisynthManifest;
