...
import { parseId } from '../../../../unisynth/src/optimizer/src/plugins/plugin';
import type { UnisynthCityVitePluginOptions } from './types';
import type { Config as SVGOConfig } from 'svgo';

/** @public */
export function imagePlugin(userOpts?: UnisynthCityVitePluginOptions): PluginOption[] {
...
export function optimizeSvg(
  ...
  userOpts?: UnisynthCityVitePluginOptions
) {
