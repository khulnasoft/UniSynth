...
/** @public */
export interface UnisynthCityVitePluginOptions extends Omit<PluginOptions, 'basePathname'> {
...
/** @public */
export interface UnisynthCityPlugin extends P<UnisynthCityPluginApi> {
  name: 'vite-plugin-unisynth-city';
}

/** @public */
export interface UnisynthCityPluginApi {
