...
import type { UnisynthCityNodeRequestOptions } from '.';

export function computeOrigin(
  req: IncomingMessage | Http2ServerRequest,
  opts?: UnisynthCityNodeRequestOptions
) {
...
export function normalizeUrl(url: string, base: string) {
  ...
  // for example: new URL("//attacker.com", "https://unisynth.build.io")
  // would return "https://attacker.com" when it should be "https://unisynth.build.io/attacker.com"
