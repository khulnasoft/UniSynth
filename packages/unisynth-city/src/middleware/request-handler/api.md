...
import type { Action } from '@khulnasoft.com/unisynth-city';
import type { _deserializeData } from '@khulnasoft.com/unisynth';
import type { EnvGetter as EnvGetter_2 } from '@khulnasoft.com/unisynth-city/middleware/request-handler';
import type { FailReturn } from '@khulnasoft.com/unisynth-city';
import type { Loader as Loader_2 } from '@khulnasoft.com/unisynth-city';
import type { UnisynthCityPlan } from '@khulnasoft.com/unisynth-city';
...
import type { RequestEvent as RequestEvent_2 } from '@khulnasoft.com/unisynth-city';
import type { RequestHandler as RequestHandler_2 } from '@khulnasoft.com/unisynth-city/middleware/request-handler';
import type { ResolveSyncValue as ResolveSyncValue_2 } from '@khulnasoft.com/unisynth-city/middleware/request-handler';
import type { _serializeData } from '@khulnasoft.com/unisynth';
import type { ValueOrPromise } from '@khulnasoft.com/unisynth';
import type { _verifySerializable } from '@khulnasoft.com/unisynth';
...
// @public (undocumented)
export type RequestHandler<PLATFORM = UnisynthCityPlatform> = (ev: RequestEvent<PLATFORM>) => Promise<void> | void;

// Warning: (ae-forgotten-export) The symbol "UnisynthSerializer" needs to be exported by the entry point index.d.ts
// Warning: (ae-forgotten-export) The symbol "UnisynthCityRun" needs to be exported by the entry point index.d.ts
//
// @public
export function requestHandler<T = unknown>(serverRequestEv: ServerRequestEvent<T>, opts: ServerRenderOptions, unisynthSerializer: UnisynthSerializer): Promise<UnisynthCityRun<T> | null>;
