...
test('creates correct headers', () => {
  const data: TestData[] = [
    ...
    { key: 'f', value: '6', options: { secure: true }, expect: 'f=6; Secure' },
    {
      key: 'g',
      value: '7',
      options: { path: '/unisynthcity/overview/' },
      expect: 'g=7; Path=/unisynthcity/overview/',
    },
    {
      key: 'h',
      value: '8',
    ...
    { key: 'i', value: '9', options: { maxAge: 60 * 60 }, expect: `i=9; Max-Age=${60 * 60}` },
    {
      key: 'j',
      value: '10',
      options: { domain: 'https://unisynth.dev' },
      expect: 'j=10; Domain=https://unisynth.dev',
    },
    {
      key: 'k',
      value: '11',
...
test('append cookies all keys are present', () => {
  const data: TestData[] = [
    ...
    { key: 'a', value: '6', options: { secure: true }, expect: 'a=6; Secure' },
    {
      ...
      value: '7',
      options: { path: '/unisynthcity/overview/' },
      expect: 'a=7; Path=/unisynthcity/overview/',
    },
    {
      key: 'a',
      value: '8',
    ...
    { key: 'a', value: '9', options: { maxAge: 60 * 60 }, expect: `a=9; Max-Age=${60 * 60}` },
    {
      ...
      value: '10',
      options: { domain: 'https://unisynth.dev' },
      expect: 'a=10; Domain=https://unisynth.dev',
    },
    {
      key: 'b',
      value: '1',
    ...
    },
    {
      ...
      value: '1',
      options: { domain: 'https://unisynth.dev' },
      expect: 'b=1; Domain=https://unisynth.dev',
    },
    {
      key: 'b',
      value: '1',
