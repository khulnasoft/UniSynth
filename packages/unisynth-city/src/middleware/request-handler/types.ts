import type { Render, RenderOptions } from '@khulnasoft.com/unisynth/server';
import type { UnisynthCityPlan, FailReturn, Action, Loader } from '@khulnasoft.com/unisynth-city';
...
/** @public */
export interface RequestEventCommon<PLATFORM = UnisynthCityPlatform>
...
export interface RequestEventBase<PLATFORM = UnisynthCityPlatform> {
   ...
   * https://unisynth.dev/docs/caching/#CDN-Cache-Controls for more information.
   */
...
declare global {
  interface UnisynthCityPlatform {}
}

/** @public */
export interface RequestEventAction<PLATFORM = UnisynthCityPlatform>
  extends RequestEventCommon<PLATFORM> {
...
/** @public */
export interface RequestEventLoader<PLATFORM = UnisynthCityPlatform>
...
/** @public */
export interface UnisynthSerializer {
