import type { ClientSPAWindow } from './unisynth-city-component';
import type { ScrollHistoryState } from './scroll-restoration';
import type { ScrollState } from './types';

import { isDev } from '@khulnasoft.com/unisynth/build';
import { event$ } from '@khulnasoft.com/unisynth';

// TODO Dedupe handler code from here and UnisynthCityProvider?
