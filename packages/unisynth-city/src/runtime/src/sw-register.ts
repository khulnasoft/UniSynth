...
((
  ...
  swReg?: UnisynthServiceWorkerRegistration,
...
interface UnisynthServiceWorker extends ServiceWorker {
  postMessage(data: QPrefetchMessage): void;
}

interface UnisynthServiceWorkerRegistration extends ServiceWorkerRegistration {
  active: UnisynthServiceWorker | null;
}
