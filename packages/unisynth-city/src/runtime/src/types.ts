...
export interface DocumentStyle {
  ...
  readonly props?: Readonly<UnisynthIntrinsicElements['style']>;
  readonly key?: string;
}
...
export interface DocumentScript {
  ...
  readonly props?: Readonly<UnisynthIntrinsicElements['script']>;
  readonly key?: string;
}
...
export interface UnisynthCityRenderDocument extends Document {}

export interface UnisynthCityEnvData {
  routeName: string;
  ev: RequestEvent;
  params: PathParams;
...
export type ActionStore<RETURN, INPUT, OPTIONAL extends boolean = true> = {
   ...
   *
   * ```tsx
   * import {action$, Form} from '@khulnasoft.com/unisynth-city';
   *
