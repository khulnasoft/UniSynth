...
import type { JSXNode as JSXNode_2 } from '@khulnasoft.com/unisynth/jsx-runtime';
...
// Warning: (ae-forgotten-export) The symbol "UnisynthEvents" needs to be exported by the entry point index.d.ts
//
// @public
...
export type UnisynthHTMLElements = {
    [tag in keyof HTMLElementTagNameMap]: Augmented<HTMLElementTagNameMap[tag], SpecialAttrs[tag]> & HTMLElementAttrs & UnisynthAttributes<HTMLElementTagNameMap[tag]>;
};
...
namespace UnisynthJSX {
    ...
    // Warning: (ae-forgotten-export) The symbol "UnisynthIntrinsicAttributes" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    interface IntrinsicAttributes extends UnisynthIntrinsicAttributes {
    }
    // Warning: (ae-forgotten-export) The symbol "LenientUnisynthElements" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    interface IntrinsicElements extends LenientUnisynthElements {
    }
}
export { UnisynthJSX as JSX }
export { UnisynthJSX }
