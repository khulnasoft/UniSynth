...
describe('q-component', () => {
   ...
   *
   * `@khulnasoft.com/unisynth/testing` ==> ../../testing/library
   */
...
<host q:version="dev" q:container="resumed" q:render="dom-dev">
  ...
  test('types work as expected', () => () => {
    ...
    type Input4Props = {
      type: 'text' | 'number';
    } & UnisynthIntrinsicElements['input'];
...
//////////////////////////////////////////////
// import { QComponent, component, qView, qHandler, getState, markDirty } from '@khulnasoft.com/unisynth';
