 ...
 *
 * `QRL` is an opaque token that is generated by the Unisynth Optimizer. (Do not rely on any properties
 ...
 * ```
 *
 * NOTE: `qrl(...)` is a result of Unisynth Optimizer transformation. You should never have to invoke
 * this function directly in your application. The `qrl(...)` function should be invoked only after
 * the Unisynth Optimizer transformation.
 *
 * ## Using `QRL`s
 *
 ...
 *
 * Use `$(...)` to tell Unisynth Optimizer to extract the expression in `$(...)` into a lazy-loadable
