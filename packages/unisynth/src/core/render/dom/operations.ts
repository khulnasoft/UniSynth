...
import { isElement, isNode, isUnisynthElement } from '../../util/element';
import { logDebug, logError, logWarn } from '../../util/log';
import { QSlot, QSlotRef, QStyle } from '../../util/markers';
import { qDev } from '../../util/qdev';
import { directGetAttribute, directSetAttribute } from '../fast-calls';
import type { RenderStaticContext } from '../types';
import type { UnisynthElement, VirtualElement } from './virtual-element';
import {
  cleanupTree,
  directAppendChild,
  directInsertAfter,
...
const _setAttribute = (el: UnisynthElement, prop: string, value: any) => {
...
export const directPrepend = (parent: UnisynthElement, newChild: Node) => {
...
export const getKey = (el: UnisynthElement): string | null => {
  return directGetAttribute(el, 'q:key');
};

export const setKey = (el: UnisynthElement, key: string | null) => {
  if (key !== null) {
