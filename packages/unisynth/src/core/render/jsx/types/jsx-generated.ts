...
import type { DOMAttributes, ClassList, UnisynthAttributes } from './jsx-unisynth-attributes';
/** @public */
...
/**
 * TS defines these with the React syntax which is not compatible with Unisynth. E.g. `ariaAtomic`
...
/**
 * @deprecated This is the type for a React Native WebView. It doesn't belong in Unisynth (yet?) but
