...
import type { EventHandler, QRLEventHandlerMulti } from './jsx-unisynth-attributes';
import type { FunctionComponent, JSXOutput } from './jsx-node';
import type { UnisynthIntrinsicElements } from './jsx-unisynth-elements';
import type { JSXChildren } from './jsx-unisynth-attributes';
import { component$, type PropsOf, type PublicProps } from '../../../component/component.public';
import type { UnisynthHTMLElements, UnisynthSVGElements, Size } from './jsx-generated';
...
describe('types', () => {
  ...
  test('basic', () => () => {
    ...
    expectTypeOf<QRLEventHandlerMulti<PointerEvent, HTMLDivElement>>().toMatchTypeOf<
      UnisynthIntrinsicElements['div']['onAuxClick$']
    >();
    expectTypeOf<UnisynthIntrinsicElements['li']['children']>().toEqualTypeOf<JSXChildren>();
    expectTypeOf<UnisynthIntrinsicElements['link']['children']>().toEqualTypeOf<undefined>();
    expectTypeOf<UnisynthIntrinsicElements['svg']['width']>().toEqualTypeOf<Size | undefined>();
  });
  ...
  test('PropsOf', () => () => {
    // tags
    expectTypeOf<PropsOf<'div'>>().toEqualTypeOf<UnisynthHTMLElements['div']>();
    expectTypeOf<PropsOf<'div'>>().not.toEqualTypeOf<UnisynthIntrinsicElements['li']>();
    expectTypeOf<PropsOf<'path'>>().toEqualTypeOf<UnisynthSVGElements['path']>();
    expectTypeOf<PropsOf<'not-exist'>>().toEqualTypeOf<UnisynthHTMLElements['span']>();
