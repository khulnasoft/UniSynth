...
type AllEventMapRaw = HTMLElementEventMap &
  ...
  WindowEventHandlersEventMap & {
    qidle: UnisynthIdleEvent;
    qinit: UnisynthInitEvent;
    qsymbol: UnisynthSymbolEvent;
    qvisible: UnisynthVisibleEvent;
  };
...
/** @public */
export type UnisynthEvents<EL, Plain extends boolean = true> = Plain extends true
  ? UnisynthKnownEventsPlain<EL> & UnisynthCustomEventsPlain<EL>
  : UnisynthKnownEvents<EL> & UnisynthCustomEvents<EL>;
...
/** @public */
export interface UnisynthIntrinsicAttributes {
  key?: string | number | null | undefined;
...
/** The Unisynth DOM attributes without plain handlers, for use as function parameters @public */
export interface UnisynthAttributes<EL extends Element>
  extends DOMAttributesBase<EL>,
    UnisynthEvents<EL, false> {
