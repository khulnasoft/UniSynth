...
const CTX_UNISYNTH_CITY = createContextId<{ value: string }>('unisynthcity');
...
export const Context = component$(() => {
  ...
  useContextProvider(CTX_UNISYNTH_CITY, {
    value: 'bye',
  });
  return (
    <>
...
export const ContextConsumer = component$(() => {
  ...
  const unisynthCity = useContext(CTX_UNISYNTH_CITY);

  return (
    <>
      {internal.value} {unisynthCity.value}
    </>
  );
});
