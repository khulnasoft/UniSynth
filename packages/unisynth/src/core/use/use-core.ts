...
import type { UnisynthDocument } from '../document';
...
declare const document: UnisynthDocument;

// Simplified version of `ServerRequestEvent` from `@khulnasoft.com/unisynth-city` package.
...
export interface InvokeContext {
  ...
  $hostElement$: UnisynthElement | undefined;
...
export const getWrappingContainer = (el: UnisynthElement): Element | null => {
