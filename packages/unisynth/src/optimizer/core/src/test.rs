...
fn example_1() {
	test_input!(TestInput {
		code: r#"
import { $, component, onRender } from '@khulnasoft.com/unisynth';
...
fn example_reg_ctx_name_segments_hoisted() {
	test_input!(TestInput {
		code: r#"
import { $, component$, server$, useStyle$ } from '@khulnasoft.com/unisynth';
...
fn example_renamed_exports() {
	test_input!(TestInput {
		code: r#"
import { component$ as Component, $ as onRender, useStore } from '@khulnasoft.com/unisynth';
...
fn example_jsx() {
	test_input!(TestInput {
		code: r#"
import { $, component$, h, Fragment } from '@khulnasoft.com/unisynth';
...
fn example_skip_transform() {
	test_input!(TestInput {
		code: r#"
import { component$ as Component, $ as onRender } from '@khulnasoft.com/unisynth';
...
fn example_parsed_inlined_qrls() {
	test_input!(TestInput {
		code: r#"
import { componentQrl, inlinedQrl, useStore, jsxs, jsx, useLexicalScope } from '@khulnasoft.com/unisynth';
...
fn example_use_server_mount() {
	test_input!(TestInput {
		code: r#"
import { component$, useTask$, useStore, useStyles$ } from '@khulnasoft.com/unisynth';
...
fn example_strip_exports_used() {
	test_input!(TestInput {
		code: r#"
import { component$, useResource$ } from '@khulnasoft.com/unisynth';
import mongodb from 'mongodb';
...
fn example_strip_server_code() {
	test_input!(TestInput {
        code: r#"
import { component$, serverLoader$, serverStuff$, $, client$, useStore, useTask$ } from '@khulnasoft.com/unisynth';
...
fn example_strip_client_code() {
	test_input!(TestInput {
		code: r#"
import { component$, useClientMount$, useStore, useTask$ } from '@khulnasoft.com/unisynth';
import mongo from 'mongodb';
import redis from 'redis';
...
export const App = component$((props) => {
    ...
    return (
        <>
            <p class="stuff" onClick$={props.onClick$}>Hello Unisynth</p>
            <Div
                class={styles.foo}
...
export const App = component$(() => {
    ...
    return (
        <>
            <p class="stuff">Hello Unisynth</p>
        </>
    );
});
"#
...
export const App = () => {
    const props = {}
    return jsx('div', props, 'Hello Unisynth');
}
"#
		.to_string(),
		transpile_ts: false,
...
export const App = component$(() => {
    return (
        <Cmp>
            <p class="stuff" onClick$={() => console.log('warn')}>Hello Unisynth</p>
        </Cmp>
    );
});
"#
...
export const App = component$((props: Stuff) => {
    return (
        <>
            ...
            <p key={props.stuff}>Hello Unisynth</p>
        </>
    );
});
"#
...
fn example_mutable_children() {
	test_input!(TestInput {
		code: r#"
import { component$, useStore, Slot, Fragment } from '@khulnasoft.com/unisynth';
...
fn example_immutable_function_components() {
	test_input!(TestInput {
		code: r#"
import { component$, useStore, Slot } from '@khulnasoft.com/unisynth';
...
fn example_build_server() {
	test_input!(TestInput {
		code: r#"
import { component$, useStore } from '@khulnasoft.com/unisynth';
import { isServer, isBrowser } from '@khulnasoft.com/unisynth/build';
...
export { unisynthify$, unisynthifyQrl, renderToString };
        "#
        .to_string(),
        filename: "../node_modules/@khulnasoft.com/unisynth-react/index.unisynth.mjs".to_string(),
        entry_strategy: EntryStrategy::Segment,
        explicit_extensions: true,
        ..TestInput::default()
    });
...
#[test]
fn example_unisynth_react_inline() {
	test_input!(TestInput {
        code: r#"
import { componentQrl, inlinedQrl, useLexicalScope, useHostElement, useStore, useTaskQrl, noSerialize, SkipRerender, implicit$FirstArg } from '@khulnasoft.com/unisynth';
import { jsx, Fragment } from '@khulnasoft.com/unisynth/jsx-runtime';
...
#[test]
fn example_unisynth_sdk_inline() {
	test_input!(TestInput {
		code: include_str!("fixtures/index.unisynth.mjs").to_string(),
		filename: "../node_modules/@khulnasoft.com/unisynth-city/index.unisynth.mjs".to_string(),
		entry_strategy: EntryStrategy::Smart,
		explicit_extensions: true,
		// mode: EmitMode::Prod,
		..TestInput::default()
...
fn relative_paths() {
	let dep = r#"
import { componentQrl, inlinedQrl, useStore, useLexicalScope } from "@khulnasoft.com/unisynth";
import { jsx, jsxs } from "@khulnasoft.com/unisynth/jsx-runtime";
...
fn example_of_synchronous_qrl() {
	test_input!(TestInput {
		code: r#"
        import { sync$, component$ } from "@khulnasoft.com/unisynth";
...
impl TestInput {
	pub fn default() -> Self {
		Self {
			...
			dev_path: None,
			src_dir: "/user/unisynth/src/".to_string(),
			root_dir: None,
			code: "/user/unisynth/src/".to_string(),
			manual_chunks: None,
			entry_strategy: EntryStrategy::Segment,
			minify: MinifyMode::Simplify,
			transpile_ts: false,
