...
export interface UnisynthManifest {
    bundles: {
        [fileName: string]: UnisynthBundle;
    };
    ...
    symbols: {
        [symbolName: string]: UnisynthSymbol;
    };
    // (undocumented)
    version: string;
}
...
export interface UnisynthVitePluginApi {
    ...
    // Warning: (ae-forgotten-export) The symbol "NormalizedUnisynthPluginOptions" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
// Warning: (ae-forgotten-export) The symbol "UnisynthVitePluginCSROptions" needs to be exported by the entry point index.d.ts
// Warning: (ae-forgotten-export) The symbol "UnisynthVitePluginSSROptions" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
