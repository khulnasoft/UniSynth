...
vite-error-overlay {
  ...
  --unisynth-dark-blue: #006ce9;
  --unisynth-light-blue: #3ec2f7;
  --unisynth-light-purple: #ac7ff4;
  --unisynth-dark-purple: #713fc2;
  --yellow: #fff;                   /* override vite yellow */
  --purple: var(--color-bright);    /* override vite purple */
  --red: var(--unisynth-light-blue);    /* override vite red */
...
vite-error-overlay::part(tip):before {
  content: "Not sure how to solve this? Visit https://unisynth.dev or connect with the community on Discord.";
  display: block;
  margin-bottom: 1em;
}
`;
