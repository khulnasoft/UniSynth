...
import type { OptimizerOptions, UnisynthBundle, UnisynthManifest } from '../types';
import {
  convertManifestToBundleGraph,
  unisynthVite,
  type UnisynthVitePlugin,
  type UnisynthVitePluginOptions,
} from './vite';
...
const getPlugin = (opts: UnisynthVitePluginOptions | undefined) =>
  (unisynthVite(opts) as any)[0] as UnisynthVitePlugin;
