import type { SnapshotResult, StreamWriter } from '@khulnasoft.com/unisynth';
import type {
  UnisynthManifest,
  SymbolMapperFn,
  SymbolMapper,
  ResolvedManifest,
} from '@khulnasoft.com/unisynth/optimizer';

/** @public */
export interface SerializeDocumentOptions {
  manifest?: UnisynthManifest | ResolvedManifest;
...
export interface RenderOptions extends SerializeDocumentOptions {
  ...
  /**
   * Specifies if the Unisynth Loader script is added to the document or not.
   *
   * Defaults to `{ include: true }`.
   */
  unisynthLoader?: UnisynthLoaderOptions;

  /**
   * Specifies if the Unisynth Prefetch Service Worker script is added to the document or not.
   *
   * Defaults to `{ include: false }`. NOTE: This may be change in the future.
   */
  unisynthPrefetchServiceWorker?: UnisynthPrefetchServiceWorkerOptions;
...
export type { SnapshotResult, SymbolMapper, UnisynthManifest, StreamWriter };
