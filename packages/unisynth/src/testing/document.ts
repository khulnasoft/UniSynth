...
import unisynthDom from '@khulnasoft.com/unisynth-dom';
...
export function createDocument(opts?: MockDocumentOptions) {
  const doc = unisynthDom.createDocument(opts?.html);
