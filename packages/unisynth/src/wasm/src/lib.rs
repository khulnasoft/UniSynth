...
use unisynth_core::TransformModulesOptions;
...
pub fn transform_modules(config_val: JsValue) -> Result<JsValue, JsValue> {
	...
	let result = unisynth_core::transform_modules(config)
...
//   let result = unisynth_core::transform_modules(&TransformModulesOptions {
