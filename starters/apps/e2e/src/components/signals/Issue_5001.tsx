...
export default component$(() => {
  ...
  // Unisynth to serialize `nakedState` into `unisynth/json`
...
export const Parent = component$<{ nakedState: [number] }>(({ nakedState }) => {
  ...
  // This means that Unisynth needs to serialize the Proxy for the `nakedState`.
  ...
  return (
    <>
      <Button
        ...
        // This seems te be because Unisynth somehow gets confused between the two
