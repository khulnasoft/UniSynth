...
export const GETTING_STARTED_STEPS = [
  ...
  },
  {
    ...
    hint: "If you need further info on how to use unisynth, have a look at <a href='https://unisynth.dev' target='_blank'>unisynth.dev</a> or join the <a href='https://unisynth.dev/chat' target='_blank'>Discord channel</a>.",
  },
];
  ...
  return (
    <div class="container container-purple container-center">
      <h2>
        Time for a
        <br />
        <span class="highlight">unisynth intro</span>?
      </h2>
