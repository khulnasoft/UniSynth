      ...
      <div class="container container-flex">
        <Infobox>
          ...
          <>
            ...
            <p>
              <code>npm run unisynth add</code>
              <br />
              Runs the unisynth CLI to add integrations
            </p>
          </>
        </Infobox>
          ...
          <Infobox>
            ...
            <ul>
              <li>
                ...
                <a href="https://unisynth.dev/chat" target="_blank">
                  Chat on discord!
                </a>
              </li>
              <li>
              ...
              <li>
                <span>Watch </span>
                <a href="https://unisynth.dev/media/" target="_blank">
