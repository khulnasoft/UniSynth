import { component$, useStyles$, useStore } from "@khulnasoft.com/unisynth";
 ...
 * Unisynth knows that it should never need to be rerendered, and its code will never
  ...
  const todos = useStore<Todos>(
    {
      filter: "all",
      items: [
        { completed: false, title: "Read Unisynth docs", id: "0" },
