...
export default component$(() => {
  ...
  useVisibleTask$(async () => {
    const url = `/unisynthcity-test/api/builder.io/oss.json`;
  ...
  return (
    <div>
      <h1>Unisynth City Test API!</h1>

      <ul>
        <li>
          <a href="/unisynthcity-test/api/builder.io/oss.json">
            /api/[org]/[user].json
          </a>
        </li>
        <li>
          <a href="/unisynthcity-test/api/data.json">/api/data.json</a>
        </li>
      </ul>
      ...
      <p>
        <button
          ...
          type="button"
          onClick$={async (_, elm) => {
            const res = await fetch("/unisynthcity-test/api/", {
              method: "PUT",
