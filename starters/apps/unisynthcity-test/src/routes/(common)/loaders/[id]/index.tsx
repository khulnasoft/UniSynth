import { component$, Resource } from "@khulnasoft.com/unisynth";
import {
  type DocumentHead,
  Form,
  Link,
...
export const useDependencyLoader = routeLoader$(
  async ({ params, redirect, json, resolveValue }) => {
    ...
    if (params.id === "redirect") {
      throw redirect(302, "/unisynthcity-test/");
    } else if (params.id === "redirect-welcome") {
      throw redirect(302, "/unisynthcity-test/loaders/welcome/");
...
export default component$(() => {
  ...
  return (
    <div class="loaders">
      ...
      <ul>
        <li>
          <Link href="/unisynthcity-test/loaders/stuff/" id="link-stuff">
            To Stuff
          </Link>
        </li>
        <li>
          <Link href="/unisynthcity-test/loaders/redirect/" id="link-redirect">
            To Redirect home
          </Link>
        </li>
        <li>
          <Link
            href="/unisynthcity-test/loaders/redirect-welcome/"
            id="link-welcome"
          >
