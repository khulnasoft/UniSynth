  ...
  return (
    <div>
      ...
      <ul>
        <li>
          <Link
            href="/unisynthcity-test/products/jacket/"
        ...
        <li>
          <Link href="/unisynthcity-test/products/hat/">Hat</Link>
        </li>
        <li>
          <Link
            href="/unisynthcity-test/products/shirt/"
        ...
        <li>
          <Link
            href="/unisynthcity-test/products/hoodie/"
        ...
        <li>
          <a
            href="/unisynthcity-test/products/hat/?json=true"
        ...
        <li>
          <a
            href="/unisynthcity-test/products/error"
...
export const useProductLoader = routeLoader$(
  async ({ headers, json, error, params, query, redirect, status }) => {
    ...
    if (query.has("querystring-test")) {
      throw redirect(301, "/unisynthcity-test/");
    }

    if (id === "shirt") {
      // Redirect, which will skip any rendering and the server will immediately redirect
      throw redirect(301, "/unisynthcity-test/products/tshirt/");
    }
